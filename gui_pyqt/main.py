...
# trang thai kep
address_status_kep = 0

# giá trị D hiện tại sau mỗi vòng loop
address_value_V_now = 1

# giá trị dòng điện hiện tại
address_value_I_now = 2
...
class Ui_main(QMainWindow):
    ...
    def read_value(self, address):
        print("read data")
        try:
            return self.master.read_register(address,functioncode=3)
        except:
    ...
    def write_value(self, address, value):
        print("write data")
        try:
            self.master.write_register(address,value, functioncode=6)
    ...
    def function_tuyChinh(self):
        ...
        self.write_value(address_value_V_now, m_master.m_value.value_D)
    ...
    def function_gap(self):
        ...
        # try:
        #     value = self.master.write_register(1,9, functioncode=6)
    ...
    def update_value(self):
        self.label_D.setText(str(self.read_value(address_value_V_now)/100))
        self.label_I.setText(str(self.read_value(address_value_I_now)/100))
        self.scroll_tuyChinh.setValue(self.read_value(address_value_V_now)/100)
        ...
        global array_D
        new_array = [[timers, float(self.label_D.text())]]
        ...
        global array_I
        new_array = [[timers, float(self.label_I.text())]]
